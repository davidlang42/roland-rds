...
pub struct Common {
    ...
    damper_polarity: bool, // (0=standard, 1=reverse)
    fc1_polarity: bool, // 0=standard, 1=reverse
    fc2_polarity: bool, // 0=standard, 1=reverse
    eq_mode: bool, // 0=live set, 1=system
    pedal_mode: bool, // 0=live set, 1=system
    s1_s2_mode: bool, // 0=live set, 1=system
...
impl Bytes<10> for Common {
    fn to_bytes(&self) -> Result<Box<[u8; Self::BYTE_SIZE]>, BytesError> {
        BitStream::write_fixed(|bs| {
            ...
            bs.set_bool(self.damper_polarity);
            bs.set_bool(self.fc1_polarity);
            bs.set_bool(self.fc2_polarity);
            bs.set_bool(self.eq_mode);
            bs.set_bool(self.pedal_mode);
            bs.set_bool(self.s1_s2_mode);
    ...
    fn from_bytes(bytes: Box<[u8; Self::BYTE_SIZE]>) -> Result<Self, BytesError> where Self: Sized {
        BitStream::read_fixed(bytes, |bs| {
            Ok(Self {
                ...
                damper_polarity: bs.get_bool(),
                fc1_polarity: bs.get_bool(),
                fc2_polarity: bs.get_bool(),
                eq_mode: bs.get_bool(),
                pedal_mode: bs.get_bool(),
                s1_s2_mode: bs.get_bool(),
